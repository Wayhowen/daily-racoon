...
from pkg.utils import get_settings, load_json_from_file, decode_base64, load_from_env,\
    string_to_dict
        ...
        if "COMMUNICATOR" in self._settings:
            if self._settings["COMMUNICATOR"] == "discord":
                ...
                try:
                    ...
                    encoded_secrets = load_from_env("DISCORD_SECRET")
                    discord_secrets = string_to_dict(decode_base64(encoded_secrets))
        ...
        if "SCRAPER" in self._settings:
            if self._settings["SCRAPER"] == "tumblr":
                ...
                try:
                    ...
                    encoded_secrets = load_from_env("TUMBLR_SECRET")
                    tumblr_secrets = string_to_dict(decode_base64(encoded_secrets))
